			...
			<div className={styles.main__block__middle}>
				<div>
					<div className={styles.main__block__middle__left}>
						<h2>Что такое UI/UX дизайн?</h2>
						<p>
							UI-дизайн — процесс визуализации прототипа, который разработали на
							основании пользовательского опыта и исследования целевой
							аудитории. UX-дизайн — это проектирование интерфейса на основе
							исследований пользовательского опыта и поведения.
						</p>
						<p>
							Разница между UX и UI — в том, что UX-дизайнер планирует, как
							пользователь взаимодействует с интерфейсом, какие шаги ему нужно
							предпринять, чтобы достичь цели. А UI-дизайнер продумывает, как
							эти шаги и путь к цели выглядят.
						</p>
					</div>
					<div className={styles.main__block__middle__right}>
						<p>
							• Вы познакомитесь с ключевыми инструментами, получите
							представления о визуальной коммуникации и научитесь применять ее
							на практике, создадите работы в Figma и потренируетесь в
							оформлении портфолио.
						</p>
						<p>
							• Вы получите все необходимые инструменты для быстрого старта в
							UX/UI-дизайне, научитесь мыслить и действовать креативно и
							соберете портфолио, которое впечатлит работодателей.
						</p>
						<p>
							• Вы узнаете, как разрабатывать цифровые продукты от идеи до
							готового макета, разберетесь в бизнес-требованиях, сможете
			...
			<div className={styles.main__block__right}>
				...
				<div className={styles.dropdown} onClick={() => click('one')}>
					...
					<div className={one ? styles.dropdown__listt : styles.dropdown_none}>
						...
						<div className={styles.dropdown__list__item}>
							<a href='#'>2. Cоздание landing page</a>
						</div>
						<div className={styles.dropdown__list__item}>
							<a href='#'>3. Pабота на dashboard, прототипирование</a>
						</div>
					</div>
				</div>
				<div className={styles.dropdown} onClick={() => click('two')}>
					...
					<div className={two ? styles.dropdown__listt : styles.dropdown_none}>
						<div className={styles.dropdown__list__item}>
							<a href='#'>
								1. Photoshop, Illustrator: базовые инструменты приложения
							</a>
						</div>
						<div className={styles.dropdown__list__item}>
							<a href='#'>
						...
						<div className={styles.dropdown__list__item}>
							<a href='#'>3. Работа над портфолио, Mockups, финальный проект</a>
						</div>
					</div>
				</div>
			</div>
