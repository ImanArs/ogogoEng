			...
			<div className={styles.main__block__left}>
				<div className={styles.main__block__left__content}>
					<div className={styles.main__block__left__header}>
						...
						<span>Frontend разработкa</span>
						<button className={styles.sign}>Записаться</button>
					</div>
				</div>
			...
			<div className={styles.main__block__middle}>
				<div>
					<div className={styles.main__block__middle__left}>
						...
						<p>
							В первую очередь JavaScript широко используется во
							фронтенд-разработке. Этот язык вместе с HTML и CSS входит в
							базовый набор инструментов фронтендера. На JavaScript создаются
							приложения, которые исполняются в браузере на стороне клиента. Они
							обеспечивают интерактивность сайтов.{' '}
						</p>
						<p>
							Сферы применения JavaScript не ограничиваются браузерами и
							веб-приложениями. С помощью этого языка решают такие задачи:
						</p>
					</div>
					<div className={styles.main__block__middle__right}>
						<p>
							• Разработка нативных приложений. Например, с помощью фреймворка
							React Native создаются приложения для Android и iOS.
						</p>
						<p>
							• Разработка десктопных приложений. JS применяется в офисных
							пакетах Microsoft и OpenOffice, в приложениях компании Adobe.
						</p>
						<p>
							• Программирование оборудования и бытовой техники, например,
							платёжных терминалов, телевизионных приставок.
						</p>
					</div>
				</div>
			...
			<div className={styles.main__block__right}>
				...
				<div className={styles.dropdown} onClick={() => click('one')}>
					...
					<div className={one ? styles.dropdown__listt : styles.dropdown_none}>
						<div className={styles.dropdown__list__item}>
							<a href='#'>1. Примитивные типы и переменные</a>
						</div>
						<div className={styles.dropdown__list__item}>
							<a href='#'>2. Создание и удаление свойств объектов</a>
						</div>
						<div className={styles.dropdown__list__item}>
							<a href='#'>3. Операторы присваивания: yнарные и бинарные</a>
						</div>
					</div>
				</div>
				<div className={styles.dropdown} onClick={() => click('two')}>
					...
					<div className={two ? styles.dropdown__listt : styles.dropdown_none}>
						<div className={styles.dropdown__list__item}>
							<a href='#'>1. Значения параметров функции по умолчанию</a>
						</div>
						<div className={styles.dropdown__list__item}>
							<a href='#'>2. Массив против Объекта</a>
						</div>
						<div className={styles.dropdown__list__item}>
							<a href='#'>3. Циклы for, do while,do, for in, for of</a>
						</div>
					</div>
				</div>
				<div className={styles.dropdown} onClick={() => click('three')}>
					...
					>
						<div className={styles.dropdown__list__item}>
							<a href='#'>1. Вызов fetch внутри промиса</a>
						</div>
						<div className={styles.dropdown__list__item}>
							<a href='#'>2. Асинхронные функции</a>
						</div>
						<div className={styles.dropdown__list__item}>
							<a href='#'>3. Обработка ошибок в асинхронных функциях</a>
						</div>
					</div>
				</div>
			</div>
