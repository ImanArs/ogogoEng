		...
		<div className={styles.installment} id='installment'>
			<div className={styles.wrapper}>
				<div className={styles.installment__block}>
					...
					<a target='_blank' rel="noreferrer" href="https://t.me/QuizBot">
				...
				<div className={styles.icon__block}>
					...
					<svg className={styles.opros} width="84" height="84" viewBox="0 0 64 64" fill="" xmlns="http://www.w3.org/2000/svg">
						<rect x="15" y="9" width="34" height="40" rx="1" stroke="black" strokeWidth="4" mask="url(#path-1-inside-1)"/>
						<rect x="12" y="6" width="40" height="52" rx="1" stroke="#D3CCC3" strokeWidth="2"/>
						<rect x="30" y="52" width="4" height="3" stroke="#D3CCC3" strokeWidth="2"/>
